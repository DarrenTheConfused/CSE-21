...
public class Lab21_Vars {
	...
	public static void main(String[] args) {
		...
		int total = 0;
		//declared total outside loop
		
		for (i = 0; i < 10; i++) {
		//old version: for (int i = 0; i < 10; i++)
			total = 0;
		//old version: int total = 0;
			total += i*i;
		}
		...
		//moved Cheese Monterey on top of cheese jack declaration
		...
		//asked for numbers first, then compared each to var3
		
		
		// Fix 7: Print out the first number entered by the user
		//        (Hint - You will need to modify the above code)
		System.out.println("First number entered by the user: " + num1);
